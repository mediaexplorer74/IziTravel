...
namespace RestSharp
{
  /// <summary>Container for data used to make requests</summary>
  public class RestRequest : IRestRequest
  {
    ...
    /// <summary>Sets Method property to value of method</summary>
    ...
    /// <summary>Sets Resource property</summary>
    ...
    /// <summary>Sets Resource and Method properties</summary>
    /// <param name="resource">Resource to use for this request</param>
    /// <param name="method">Method to use for this request</param>
    ...
    /// </summary>
    /// <example>request.AddObject(product, "ProductId", "Price", ...);</example>
    ...
    public IRestRequest AddObject(object obj, params string[] includedProperties)
    {
      ...
      {
        if (includedProperties.Length == 0 || includedProperties.Length > 0 && ((IEnumerable<string>) includedProperties).Contains<string>(property.Name))
        {
          ...
          if (source != null)
          {
            if (propertyType.IsArray)
            {
              ...
              source = ((Array) source).Length <= 0 || elementType == null || !elementType.IsPrimitive && !elementType.IsValueType && elementType != typeof (string) ? (object) string.Join(",", (string[]) source) : (object) string.Join(",", ((Array) source).Cast<object>().Select<object, string>((Func<object, string>) (item => item.ToString())).ToArray<string>());
            }
            this.AddParameter(property.Name, source);
          }
        }
      }
      return (IRestRequest) this;
    ...
    /// <summary>Add the parameter to the request</summary>
    ...
    {
      Func<string, bool> func = (Func<string, bool>) (host => Uri.CheckHostName(Regex.Split(host, ":\\d+")[0]) == UriHostNameType.Unknown);
    ...
    /// <summary>Shortcut to AddParameter(name, value, Cookie) overload</summary>
    ...
    {
      return this.AddParameter(name, (object) value, ParameterType.QueryString);
    }
    ...
    /// </summary>
    public void IncreaseNumAttempts() => ++this.Attempts;
