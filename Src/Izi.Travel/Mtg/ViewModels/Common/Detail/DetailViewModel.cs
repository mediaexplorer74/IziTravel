// ********************************************************************
// Type: Izi.Travel.Mtg.ViewModels.Common.Detail.DetailViewModel
...
using Izi.Travel.Mtg.ViewModels.Common.Detail.Flyouts;
...
namespace Izi.Travel.Mtg.ViewModels.Common.Detail
{
    ...
    IHandle<DataLoadedMessage>
  {
    ...
    public BaseCommand ShareCommand
    {
      get
      {
        return this._shareCommand ?? (this._shareCommand = (BaseCommand) new Izi.Travel.Mtg.Commands.ShareCommand(this.MtgObject, this.MtgObjectParent));
      }
    }
