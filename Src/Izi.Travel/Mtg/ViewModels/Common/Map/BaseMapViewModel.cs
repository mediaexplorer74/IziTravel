...
namespace Izi.Travel.Shell.Mtg.ViewModels.Common.Map
{
  public abstract class BaseMapViewModel : Screen
  {
        ...
        private bool _isDataLoading;
        private bool _isInitializing;
        private Geopoint _center = new Geopoint(new BasicGeoposition());
        private Geopoint _viewCenter = new Geopoint(new BasicGeoposition());
        private Geopoint _userLocation = new Geopoint(new BasicGeoposition());
        private LocationRectangle _locationRect;
        private double _zoomLevel = 14.0;
        private double _viewZoomLevel;
        private readonly ObservableCollection<BaseMapItemViewModel> _items;
        ...
        private RelayCommand _zoomInCommand;
        private RelayCommand _zoomOutCommand;
        private object LocateUserCommand;
    ...
    private async Task GetCurrentUserLocationAsync()
    {
        var geolocator = new Geolocator();
        var position = await geolocator.GetGeopositionAsync();
        _userLocation = position.Coordinate.Point;
    }
