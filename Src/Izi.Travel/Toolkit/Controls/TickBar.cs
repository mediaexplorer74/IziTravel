// ********************************************************************
// Type: Izi.Travel.Toolkit.Controls.TickBar
...
using Windows.UI.Xaml; // using System.Windows;
  ...
  public sealed class TickBar : Control
  {
    ...
    public static readonly DependencyProperty FillProperty 
            = DependencyProperty.Register(nameof (Fill), typeof (Brush), typeof (TickBar),
                new PropertyMetadata((PropertyChangedCallback) ((d, e) => ((TickBar) d).OnFillChanged(e))));
    private static readonly DependencyProperty MinimumProperty 
            = DependencyProperty.Register(nameof (Minimum), typeof (double), typeof (TickBar), 
                new PropertyMetadata((object) 0.0, (PropertyChangedCallback) ((d, e) => ((TickBar) d).UpdateTicks())));
    private static readonly DependencyProperty MaximumProperty 
            = DependencyProperty.Register(nameof (Maximum), typeof (double), typeof (TickBar), 
                new PropertyMetadata((object) 1.0, (PropertyChangedCallback) ((d, e) => ((TickBar) d).UpdateTicks())));
    private static readonly DependencyProperty TickFrequencyProperty 
            = DependencyProperty.Register(nameof (TickFrequency), typeof (double), typeof (TickBar),
                new PropertyMetadata((object) 0.0, (PropertyChangedCallback) ((d, e) => ((TickBar) d).UpdateTicks())));
    private static readonly DependencyProperty IsDirectionReversedProperty 
            = DependencyProperty.Register(nameof (IsDirectionReversed), typeof (bool), typeof (TickBar),
                new PropertyMetadata((object) false, (PropertyChangedCallback) ((d, e) => ((TickBar) d).UpdateTicks())));
    private static readonly DependencyProperty OrientationProperty 
            = DependencyProperty.Register(nameof (Orientation), typeof (Orientation), typeof (TickBar),
    ...
    public override void OnApplyTemplate()
    {
      ...
      this.container = this.GetFirstLogicalChildByType<Canvas>(false);
    ...
    private void BindToTemplatedParent(DependencyProperty target, string source)
    {
      ...
      {
        RelativeSource = default,//new RelativeSource(RelativeSourceMode.TemplatedParent),
        Path = default//new PropertyPath(source, new object[0])
      });
    }
  }
}
