// ********************************************************************
// Type: Izi.Travel.Toolkit.Controls.PhoneSlider
  ...
  public class PhoneSlider : Slider
  {
    ...
    public static readonly DependencyProperty TickFrequencyProperty = 
            DependencyProperty.Register(nameof (TickFrequency), typeof (double), 
                typeof (PhoneSlider), new PropertyMetadata((object) 0.0, 
                    new PropertyChangedCallback(PhoneSlider.OnTickFrequencyChanged)));
    ...
    protected override void OnValueChanged(double oldValue, double newValue)
    {
      if (!this._isSettingValue && this.TickFrequency > 0.0)
      {
        ...
        double num2 = Math.Abs(num1 - newValue) >= Math.Abs(this.Maximum - newValue)
                    ? this.Maximum 
                    : num1;
