// ********************************************************************
// Type: Izi.Travel.Toolkit.Controls.TemplatedVisualTreeExtensions
...
namespace Izi.Travel.Toolkit.Controls
{
  ...
  {
    public static T GetFirstLogicalChildByType<T>
            (this FrameworkElement parent, bool applyTemplates) where T : FrameworkElement
    {
