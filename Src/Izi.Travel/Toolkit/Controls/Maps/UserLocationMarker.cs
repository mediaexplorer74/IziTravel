// ********************************************************************
// Type: Izi.Travel.Toolkit.Controls.Maps.UserLocationMarker
...
namespace Izi.Travel.Toolkit.Controls.Maps
{
  ...
  public sealed class UserLocationMarker : MapChildControl
  {
    public static readonly DependencyProperty RadiusProperty 
            = DependencyProperty.Register(nameof (Radius), typeof (Thickness),
                typeof (UserLocationMarker), new PropertyMetadata((object) new Thickness()));
    public static readonly DependencyProperty IsActiveProperty 
            = DependencyProperty.Register(nameof (IsActive), typeof (bool), 
                typeof (UserLocationMarker), new PropertyMetadata((object) false, 
                    new PropertyChangedCallback(UserLocationMarker.IsActivePropertyChangedCallback)));
    private Map _map;
    ...
    private void Activate()
    {
      ...
      if (this._map == null)
        return;
      this._map.ZoomLevelChanged += this.Map_ZoomLevelChanged;

      Izi.Travel.Business.Managers.Geotracker.Instance.PositionChanged += 
                GeotrackerOnPositionChanged;
      ((Action) (async () =>
      {
    ...
    private void Deactivate()
    {
      ...
      if (this._map == null)
        return;
      //this._map.ZoomLevelChanged -= new EventHandler<MapZoomLevelChangedEventArgs>(
      //    this.Map_ZoomLevelChanged);
    ...
    private void UpdateRadius()
    {
      ...
      if (double.IsNaN(this.GeoCoordinate.HorizontalAccuracy))
        this.GeoCoordinate.HorizontalAccuracy = 5.0;
            this.Radius = new Thickness(
                -GeoHelper.MetersToPixels(this.GeoCoordinate.HorizontalAccuracy,
                this.GeoCoordinate.Latitude, this._map.ZoomLevel));//.Clamp(0.0, 480.0));
    }
  }
}
