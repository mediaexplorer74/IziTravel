// ********************************************************************
// Type: Izi.Travel.Toolkit.Controls.Maps.MapExtensions
...
namespace Izi.Travel.Toolkit.Controls.Maps
{
  public static class MapExtensions
  {
    public static readonly DependencyProperty ChildrenProperty 
            = DependencyProperty.RegisterAttached("Children",
                typeof (DependencyObjectCollection<DependencyObject>), typeof (MapExtensions), (PropertyMetadata) null);
    private static readonly DependencyProperty ChildrenChangedManagerProperty 
            = DependencyProperty.RegisterAttached("ChildrenChangedManager",
                typeof (MapExtensionsChildrenChangeManager), typeof (MapExtensions), (PropertyMetadata) null);

    public static DependencyObjectCollection<DependencyObject> GetChildren(Map element)
    {
      DependencyObjectCollection<DependencyObject> sourceCollection = element != null 
                ? (DependencyObjectCollection<DependencyObject>) 
                element.GetValue(MapExtensions.ChildrenProperty)
      ...
      if (sourceCollection == null)
      {
        ...
        MapExtensionsChildrenChangeManager childrenChangeManager 
                    = new MapExtensionsChildrenChangeManager((INotifyCollectionChanged) sourceCollection)
        {
          Map = element
        };
