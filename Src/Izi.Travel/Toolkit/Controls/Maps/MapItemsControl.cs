  ...
  public sealed class MapItemsControl : DependencyObject
  {
    public static readonly DependencyProperty ItemsSourceProperty 
            = DependencyProperty.Register(nameof (ItemsSource), typeof (IEnumerable),
                ...
                new PropertyMetadata(new PropertyChangedCallback(MapItemsControl.OnItemsSourceChanged)));

    public static readonly DependencyProperty ItemTemplateProperty 
            = DependencyProperty.Register(nameof (ItemTemplate), typeof (DataTemplate), 
                typeof (MapItemsControl), 
                new PropertyMetadata(new PropertyChangedCallback(MapItemsControl.OnItemTemplateChanged)));

    public static readonly DependencyProperty NameProperty 
            = DependencyProperty.Register(nameof (Name), typeof (string),
                typeof (MapItemsControl), (PropertyMetadata) null);

    public static readonly DependencyProperty SelectedItemProperty 
            = DependencyProperty.Register(nameof (SelectedItem),
                typeof (object), typeof (MapItemsControl), 
                new PropertyMetadata((PropertyChangedCallback) (async (s, e) =>
    {
