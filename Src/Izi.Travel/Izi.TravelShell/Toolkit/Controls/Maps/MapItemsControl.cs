...
namespace Izi.Travel.Shell.Toolkit.Controls.Maps
{
  ...
  public sealed class MapItemsControl : DependencyObject
  {
    ...
    public static readonly DependencyProperty NameProperty = DependencyProperty.Register(nameof (Name), typeof (string), typeof (MapItemsControl), (PropertyMetadata) null);
    public static readonly DependencyProperty SelectedItemProperty = DependencyProperty.Register(nameof (SelectedItem), typeof (object), typeof (MapItemsControl), new PropertyMetadata((PropertyChangedCallback) (async (s, e) =>
    {
      await Task.Delay(250);
      if (e.NewValue == null)
        return;
      ((MapItemsControl) s).ItemsChangeManager.MoveToTop(e.NewValue);
    })));

    public object SelectedItem
    {
      get => this.GetValue(MapItemsControl.SelectedItemProperty);
      set => this.SetValue(MapItemsControl.SelectedItemProperty, value);
    }
