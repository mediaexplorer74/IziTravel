...
namespace Izi.Travel.Settings.Helpers
{
  public class UserVoiceHelper
  {
    ...
    {
       return "v1.0";//Assembly.GetExecutingAssembly().GetName().Version.ToString();
    }

    private static string GetOsVersion() => "10.0";//Environment.OSVersion.ToString();

    private static string GetPhoneModel()
    {
       return "Lumia 950";//string.Format("{0} {1}", (object) DeviceStatus.DeviceManufacturer, (object) DeviceStatus.DeviceName);
    }

    private static string GetMemoryUsage()
    {
       return "100000";//string.Format("{0}/{1}", (object) (DeviceStatus.ApplicationCurrentMemoryUsage / 1024L / 1024L), (object) (DeviceStatus.ApplicationMemoryUsageLimit / 1024L / 1024L));
    }
