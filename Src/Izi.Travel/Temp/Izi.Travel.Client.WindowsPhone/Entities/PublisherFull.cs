...
// Type: Izi.Travel.Client.Entities.PublisherFull
...
{
  [JsonObject]
  public class PublisherFull : PublisherBase
  {
    [JsonProperty(PropertyName = "content")]
    public List<PublisherContent> Content { get; set; }

    [JsonProperty(PropertyName = "contacts")]
    public PublisherContacts Contacts { get; set; }
  }
}
