...
namespace Izi.Travel.Business.Entities.Data
{
  public class GeoLocation
  {
    ...
    {
      return Math.Abs(this.Latitude) > double.Epsilon || Math.Abs(this.Longitude) > double.Epsilon || Math.Abs(this.Altitude) > double.Epsilon ? new GeoCoordinate(this.Latitude, this.Longitude, this.Altitude) : GeoCoordinate.Unknown;
    }
