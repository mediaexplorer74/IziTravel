...
// Type: Izi.Travel.Business.Entities.Download.DownloadProcessError
...
{
  public enum DownloadProcessError
  {
    None,
    Unknown,
    ProcessCanceled,
    PackageCreateLocal,
    PackageCreateRemote,
    PackageCreateRemoteConnectionFailed,
    PackageDownload,
    PackageDownloadConnectionFailed,
    PackageDownloadFileNotExists,
    PackageDownloadNotEnoughSpace,
    PackageCopyMedia,
