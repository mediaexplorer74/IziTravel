...
namespace Izi.Travel.Shell.Mtg.Controls
{
  ...
  public class BarcodeScanner : Control
  {
    ...
    public BarcodeScanner()
    {
      ...
      this._scanTimer.Tick += new EventHandler(this.OnScanTimerTick);
    }

    public override void OnApplyTemplate()
    {
      base.OnApplyTemplate();
      this._progress = this.GetTemplateChild("PartProgress") as ProgressOverlay;
      ...
      if (this._grid != null)
      {
        ...
        this._grid.Background = (Brush) this._videoBrush;
      }
    ...
    private void Initialize()
    {
      ...
      this._photoCamera.Initialized += new EventHandler<CameraOperationCompletedEventArgs>(this.OnPhotoCameraInitialized);
    ...
    private void Deinitialize()
    {
      ...
      if (this._photoCamera != null)
      {
        ...
        this._photoCamera.Initialized -= new EventHandler<CameraOperationCompletedEventArgs>(this.OnPhotoCameraInitialized);
        this._photoCamera.AutoFocusCompleted -= new EventHandler<CameraOperationCompletedEventArgs>(this.OnPhotoCameraAutoFocusCompleted);
    ...
    private void OnInitialized()
    {
      if (this._photoCamera == null)
        return;
      this._photoCamera.FlashMode = FlashMode.Auto;
      this._photoCamera.AutoFocusCompleted += new EventHandler<CameraOperationCompletedEventArgs>(this.OnPhotoCameraAutoFocusCompleted);
      this._previewBuffer = new WriteableBitmap((int) this._photoCamera.PreviewResolution.Width, (int) this._photoCamera.PreviewResolution.Height);
    ...
    private void OnAutoFocusCompleted()
    {
      if (this._photoCamera == null || !this._isCameraInitialized)
        return;
      this._photoCamera.GetPreviewBufferArgb32(this._previewBuffer.Pixels);
