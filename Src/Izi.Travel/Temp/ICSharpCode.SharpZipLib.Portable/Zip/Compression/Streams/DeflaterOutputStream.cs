...
namespace ICSharpCode.SharpZipLib.Zip.Compression.Streams
{
  ...
  public class DeflaterOutputStream : Stream
  {
    ...
    /// When the flag is true <see cref="M:ICSharpCode.SharpZipLib.Zip.Compression.Streams.DeflaterOutputStream.Dispose(System.Boolean)"></see> will close the underlying stream also.
    /// </summary>
    ...
    /// <summary>Get/set the password used for encryption.</summary>
    ...
    /// <summary>Encrypt a block of data</summary>
    /// <param name="buffer">
    ...
    /// <summary>Encrypt a single byte</summary>
    ...
    /// <summary>Update encryption keys</summary>
    ...
    /// <summary>Gets value indicating stream can be read from</summary>
    ...
    /// <summary>Get value indicating if this stream supports writing</summary>
    public override bool CanWrite => this.baseOutputStream_.CanWrite;

    /// <summary>Get current length of stream</summary>
    ...
    /// <summary>Read a byte from stream advancing position by one</summary>
    ...
    /// <summary>Read a block of bytes from stream</summary>
    ...
    /// <summary>Writes a single byte to the compressed output stream.</summary>
    ...
    /// <summary>Writes bytes from an array to the compressed stream.</summary>
