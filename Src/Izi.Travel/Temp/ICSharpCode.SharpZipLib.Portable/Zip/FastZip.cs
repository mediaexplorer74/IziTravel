...
namespace ICSharpCode.SharpZipLib.Zip
{
  ...
  public class FastZip
  {
    ...
    /// <summary>Get / set the password value.</summary>
    ...
    /// <summary>Create a zip file/archive.</summary>
    /// <param name="zipFileName">The name of the zip file to create.</param>
    ...
    /// <summary>Extract the contents of a zip file.</summary>
    ...
    /// <summary>Extract the contents of a zip file held in a stream.</summary>
...
label_16:
    ...
    {
      /// <summary>Prompt the user to confirm overwriting</summary>
      Prompt,
      /// <summary>Never overwrite files.</summary>
      Never,
      /// <summary>Always overwrite files.</summary>
      Always,
    }

    /// <summary>Delegate called when confirming overwriting of files.</summary>
