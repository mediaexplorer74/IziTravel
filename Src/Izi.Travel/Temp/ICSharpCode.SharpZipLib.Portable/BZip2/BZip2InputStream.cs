...
namespace ICSharpCode.SharpZipLib.BZip2
{
  ...
  public class BZip2InputStream : Stream
  {
    ...
    /// <summary>Construct instance for reading from stream</summary>
    ...
    /// When the flag is true <see cref="M:ICSharpCode.SharpZipLib.BZip2.BZip2InputStream.Dispose(System.Boolean)"></see> will close the underlying stream also.
    /// </summary>
    ...
    /// <summary>Gets a value indicating if the stream supports reading</summary>
    ...
    /// <summary>Closes the stream, releasing any associated resources.</summary>
