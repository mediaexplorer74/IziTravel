...
namespace ICSharpCode.SharpZipLib.BZip2
{
  ...
  public class BZip2OutputStream : Stream
  {
    ...
    /// <summary>Read a byte from the stream advancing the position.</summary>
    ...
    /// <summary>Read a block of bytes</summary>
    ...
    /// <summary>Write a block of bytes to the stream</summary>
    ...
    /// <summary>Get the number of bytes written to output.</summary>
    ...
    /// <summary>Get the number of bytes written to the output.</summary>
    ...
    /// <summary>Flush output buffers</summary>
