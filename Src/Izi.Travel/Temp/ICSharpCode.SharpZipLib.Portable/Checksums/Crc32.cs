...
namespace ICSharpCode.SharpZipLib.Checksums
{
  ...
  public sealed class Crc32 : IChecksum
  {
    ...
    /// <summary>The crc data checksum so far.</summary>
    private uint crc;
    ...
    /// <summary>Returns the CRC32 data checksum computed so far.</summary>
    public long Value
    {
      get => (long) this.crc;
    ...
    /// <summary>Updates the checksum with the int bval.</summary>
