...
namespace HtmlAgilityPack
{
  ...
  public class HtmlDocument
  {
    ...
    /// <summary>Defines if output must conform to XML, instead of HTML.</summary>
    ...
    {
      return html != null ? new Regex("&(?!(amp;)|(lt;)|(gt;)|(quot;))", RegexOptions.IgnoreCase).Replace(html, "&amp;").Replace("<", "&lt;").Replace(">", "&gt;").Replace("\"", "&quot;") : throw new ArgumentNullException(nameof (html));
    }
    ...
    public Encoding DetectEncoding(TextReader reader)
    {
      ...
      this._streamencoding = !(reader is StreamReader streamReader) ? (Encoding) null : streamReader.CurrentEncoding;
    ...
    public HtmlNode GetElementbyId(string id)
    {
      ...
      return !this.Nodesid.ContainsKey(id.ToLower()) ? (HtmlNode) null : this.Nodesid[id.ToLower()];
    }
    ...
    /// <summary>Loads the HTML document from the specified TextReader.</summary>
    ...
    /// <summary>Saves the HTML document to the specified StreamWriter.</summary>
    ...
    private HtmlNode FindResetterNode(HtmlNode node, string name)
    {
      ...
      if (dictionaryValueOrNull.Closed)
        return (HtmlNode) null;
      return dictionaryValueOrNull._streamposition < node._streamposition ? (HtmlNode) null : dictionaryValueOrNull;
    }
