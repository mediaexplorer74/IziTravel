...
namespace RestSharp.Reflection
{
  ...
  internal class ReflectionUtils
  {
    ...
    {
      return info == null || type == null || !Attribute.IsDefined(info, type) ? (Attribute) null : Attribute.GetCustomAttribute(info, type);
    }
    ...
    {
      return objectType == null || attributeType == null || !Attribute.IsDefined((MemberInfo) objectType, attributeType) ? (Attribute) null : Attribute.GetCustomAttribute((MemberInfo) objectType, attributeType);
    }
