// IziTravel.Communication.Html.BaseHtmlWrapper

using System;
using System.Text.RegularExpressions;

#nullable disable
namespace IziTravel.Communication.Html
{
  public class BaseHtmlWrapper
  {
    ...
    protected string WrapToHtmlWithCss(string contentString, string css)
    {
      return string.Format(
          "<html><head> <meta name='viewport' content='width=500px' /><style type=\"text/css\">{0}</style></head><body>{1}</body></html>", (object) css, (object) this.ToExtendedASCII(contentString));
    }
