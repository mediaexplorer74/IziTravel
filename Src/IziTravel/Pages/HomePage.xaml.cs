...
using static IziTravel.MainPage;
...
namespace IziTravel
{
    ...
    public sealed partial class HomePage : Windows.UI.Xaml.Controls.Page
    {
        ...
        public HomePage()
        {
            ...
            HomePageTxt.Text += 
                "This is in ongoing development, suggestions and feedback are welcome. " +
        ...
        private async void CheckForUpdate()
        {
            ...
            if (latestRelease.Assets != null && latestRelease.Assets.Count > 0)
            {
                ...
                else
                {
                    ...
                    UpdateURL = $"https://github.com/mediaexplorer74/IziTravel/releases/download/{latestRelease.TagName}/{UploadedFileName}";
                    // string updateURL = $"https://github.com/mediaexplorer74/IziTravel/releases/download/1.13.16-prerelease/Easy-Fetch_1.13.16.0_Debug_Test.zip";
            ...
            try
            {
                ...
                using (var zipArchive = ArchiveFactory.Open(zipStream))
                {
                    ...
                    while (reader.MoveToNextEntry())
                    {
                        ...
                        {
                            await reader.WriteEntryToDirectory(
                             Windows.Storage.ApplicationData.Current.LocalCacheFolder, new ExtractionOptions()
                ...
                await Windows.System.Launcher.LaunchFileAsync(
                     await Windows.Storage.ApplicationData.Current.LocalCacheFolder.GetFileAsync(AppxUpdateName), 
            options);
