...
namespace IziTravel
{
    ...
    public sealed partial class MainPage : Page
    {
        public MainPage()
        {
            ...
            var HomePage = $"IziTravel.HomePage";
        ...
        {
            //ToAboutMe();
            IziTravel.AppServices.ViewModels.MainPivot.MainPivotViewModel vm = (IziTravel.AppServices.ViewModels.MainPivot.MainPivotViewModel)DataContext;
            vm.RefreshData();
        }//AboutApp_Click
        ...
        public void NavigateToPage(object pageTag)
        {
            ...
            var pageName = $"IziTravel.{pageTag}";
