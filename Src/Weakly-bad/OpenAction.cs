...
namespace Weakly
{
  ...
  public static class OpenAction
  {
      ...
      MethodInfo method)
    {
      ...
      return Expression.Lambda<Action<object, T1, T2, T3, T4, T5>>(
          (Expression) Expression.Call((Expression) Expression.Convert(
              (Expression) parameterExpression1, method.DeclaringType), method, 
              (Expression) parameterExpression2, (Expression) parameterExpression3, 
              (Expression) parameterExpression4, (Expression) parameterExpression5,
              (Expression) parameterExpression6), parameterExpression1, 
          parameterExpression2, parameterExpression3, parameterExpression4,
          parameterExpression5, parameterExpression6).Compile();
    }
  }
}
