...
// Type: Izi.Travel.Business.Entities.Analytics.Parameters.UidParameter
...
{
  public sealed class UidParameter : BaseParameter
  {
    private const int ParamIndex = 2;

    public UidParameter(string value)
      : base(2, value)
    {
    }
  }
