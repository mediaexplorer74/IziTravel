...
// Type: Izi.Travel.Business.Entities.Analytics.Parameters.TitleParameter
...
{
  public sealed class TitleParameter : BaseParameter
  {
    private const int ParamIndex = 1;

    public TitleParameter(string value)
      : base(1, value)
    {
    }
  }
