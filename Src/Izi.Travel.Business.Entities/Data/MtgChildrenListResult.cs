...
// Type: Izi.Travel.Business.Entities.Data.MtgChildrenListResult
...
{
  public class MtgChildrenListResult
  {
    public MtgChildrenListResultMetadata Metadata { get; set; }

    public MtgObject[] Data { get; set; }
  }
}
