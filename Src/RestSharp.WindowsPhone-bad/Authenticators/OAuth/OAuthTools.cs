...
namespace RestSharp.Authenticators.OAuth
{
  internal static class OAuthTools
  {
    ...
    public static string UrlEncodeStrict(string value)
    {
      ...
      value.ForEach<char>((Action<char>) (c => result += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz1234567890-._~".Contains<char>(c) ? c.ToString() : c.ToString().PercentEncode()));
      return result;
    }
