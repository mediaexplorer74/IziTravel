...
namespace Weakly
{
  ...
  public static class OpenFunc
  {
    ...
    {
      Func<object, TResult> valueOrDefault = OpenFunc.Cache.GetValueOrDefault<Func<object, TResult>>(method);
    ...
    {
      return ((Expression<Func<object, TResult>>) (instance => Expression.Call((Expression) Expression.Convert(instance, method.DeclaringType), method))).Compile();
    }
    ...
    private static Func<object, T, TResult> CompileFunc<T, TResult>(MethodInfo method)
    {
      ...
      return Expression.Lambda<Func<object, T, TResult>>((Expression) Expression.Call((Expression) Expression.Convert((Expression) parameterExpression1, method.DeclaringType), method, (Expression) parameterExpression2), parameterExpression1, parameterExpression2).Compile();
    }
    ...
    {
      Func<object, T1, T2, TResult> valueOrDefault = OpenFunc.Cache.GetValueOrDefault<Func<object, T1, T2, TResult>>(method);
      if (valueOrDefault != null)
        return valueOrDefault;
    ...
    {
      return ((Expression<Func<object, T1, T2, TResult>>) ((instance, arg1, arg2) => Expression.Call((Expression) Expression.Convert(instance, method.DeclaringType), method, arg1, arg2))).Compile();
    }
    ...
    private static Func<object, T1, T2, T3, TResult> CompileFunc<T1, T2, T3, TResult>(
      MethodInfo method)
    {
      return ((Expression<Func<object, T1, T2, T3, TResult>>) ((instance, arg1, arg2, arg3) => Expression.Call((Expression) Expression.Convert(instance, method.DeclaringType), method, arg1, arg2, arg3))).Compile();
    }
