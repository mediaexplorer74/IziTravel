...
// Type: Izi.Travel.Shell.Mtg.ViewModels.Common.Detail.DetailReviewListViewModel
...
namespace Izi.Travel.Shell.Mtg.ViewModels.Common.Detail
{
  ...
  public class DetailReviewListViewModel : DetailTabViewModel
  {
    public override string DisplayName
    {
      get => AppResources.LabelReviews.ToLower();
      set => throw new NotImplementedException();
    }

    protected override void OnInitialize()
    {
      this.ActiveItem = (IScreen) IoC.Get<ReviewListViewModel>();
      base.OnInitialize();
    }
