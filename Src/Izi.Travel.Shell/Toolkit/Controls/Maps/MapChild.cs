...
namespace Izi.Travel.Shell.Toolkit.Controls.Maps
{
  public static class MapChild
  {
    public static readonly DependencyProperty GeoCoordinateProperty = 
            DependencyProperty.RegisterAttached("GeoCoordinate", typeof (object),
                typeof (MapChild), (PropertyMetadata) null);
    public static readonly DependencyProperty PositionOriginProperty = 
            DependencyProperty.RegisterAttached("PositionOrigin", typeof (Point),
                typeof (MapChild), (PropertyMetadata) null);
    internal static readonly DependencyProperty ToolkitCreatedProperty = 
            DependencyProperty.RegisterAttached("ToolkitCreated", typeof (bool), 
                typeof (MapChild), (PropertyMetadata) null);

    //[TypeConverter(typeof (GeoCoordinateConverter))]
    public static GeoCoordinate GetGeoCoordinate(DependencyObject element)
    {
      return element != null ? (GeoCoordinate) element.GetValue(MapChild.GeoCoordinateProperty)
    ...
    {
      return element != null
                ? (Point) element.GetValue(MapChild.PositionOriginProperty) 
                : throw new ArgumentNullException(nameof (element));
    }
